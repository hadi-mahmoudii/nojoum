...
class PostDetailsHeader extends StatefulWidget {
  ...
  @override
  State<PostDetailsHeader> createState() => _PostDetailsHeaderState();
}

class _PostDetailsHeaderState extends State<PostDetailsHeader> {
  late bool isLiked;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Get.toNamed(Routes.postDetails, arguments: widget.post),
      child: ListView(
        shrinkWrap: true,
